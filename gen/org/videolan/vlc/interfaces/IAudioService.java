 ...
 * Original file: /home/ieee8023/android/vlc-android/src/org/videolan/vlc/interfaces/IAudioService.aidl
 */
...
this.load(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<java.lang.String> _result = this.getItems();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getItem();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
@Override public void load(java.util.List<java.lang.String> mediaPathList, int position, boolean libvlcBacked, boolean noVideo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(((libvlcBacked)?(1):(0)));
...
@Override public java.util.List<java.lang.String> getItems() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public java.lang.String getItem() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public void showWithoutParse(java.lang.String URI) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getCurrentMediaLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_load = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_append = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getItems = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_isPlaying = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isShuffling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getRepeatType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setRepeatType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_hasMedia = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_hasNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_hasPrevious = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getTitle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getArtist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getAlbum = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getLength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getCover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_addAudioCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_removeAudioCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_detectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_showWithoutParse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
}
...
public void load(java.util.List<java.lang.String> mediaPathList, int position, boolean libvlcBacked, boolean noVideo) throws android.os.RemoteException;
public void append(java.util.List<java.lang.String> mediaPathList) throws android.os.RemoteException;
public java.util.List<java.lang.String> getItems() throws android.os.RemoteException;
public java.lang.String getItem() throws android.os.RemoteException;
...
public void showWithoutParse(java.lang.String URI) throws android.os.RemoteException;
